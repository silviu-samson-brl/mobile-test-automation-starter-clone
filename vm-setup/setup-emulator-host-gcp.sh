...
echo ""
echo "  Next steps:"
echo "    1. Create emulators using proxy-setup-kit:"
...
# Apply KVM group and reload env vars so proxy-setup-kit works immediately
echo ">>> Dropping into a new shell with KVM group and env vars loaded..."
exec newgrp kvm
